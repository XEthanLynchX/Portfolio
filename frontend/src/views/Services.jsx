            ...
            <div className="relative z-10 flex flex-col justify-center items-center rounded-2xl p-4">
              ...
              <div className='flex-wrap md:flex-nowrap md:flex  justify-center md:justify-between space-y-8 md:space-y-0 md:space-x-8 p-4'>
                <div className='card bg-darkblue text-white p-8 rounded-lg w-full md:w-1/3 hover:shadow-glow'>
                  ...
                  <p className='text-xs md:text-sm mt-4 mb-4'>Enhances your website's functionality and design, ensuring a seamless user experience. </p>
             ...
             <div className="flex flex-col md:flex-row items-center justify-around mt-8 md:mt-32 p-4 sm:p-10 font-cambria">
              ...
              <div className="pricing-container flex flex-col items-center justify-center min-h-screen p-4 sm:p-10 font-cambria mt-28 " ref={pricingContainerRef}>
                ...
                <div className="pricing-table grid grid-cols-1 md:grid-cols-4 gap-8 mt-16">
                  {/* Basic Package */}
                  <div className="card bg-darkblue text-white p-8 rounded-lg text-center hover:shadow-glow">
                    <h3 className="text-xl text-white mb-4 font-bold">Basic</h3>
                    <p className="text-2xl text-white font-bold mb-4">$1500</p>
                    <ul className=" mb-8">
                      <li className="mb-2">Clean Website Design</li>
                      <li className="mb-2">Responsive Layout</li>
                      <li className="mb-2">5 Pages</li>
                      <li className="mb-2">Basic SEO</li>
                      <li className="mb-2">Free Small changes</li>
                    </ul>
                    <Link to='/contact' className='text-center'>
                    <button className=" text-white font-medium rounded-lg text-sm px-5 py-2.5">Get Started</button></Link>
                  </div>

                  {/* Standard Package */}
                  <div className="card bg-darkblue text-white p-8 rounded-lg hover:shadow-glow">
                    <h3 className="text-xl text-white mb-4 font-bold">Standard</h3>
                    <p className="text-2xl text-white font-bold mb-4">$2500</p>
                    <ul className=" mb-8">
                      <li className="mb-2">Advanced Website Design</li>
                      <li className="mb-2">Responsive Layout</li>
                      <li className="mb-2">10 Pages</li>
                      <li className="mb-2">Advanced SEO</li>
                      <li className="mb-2">Free Larger Changes</li>
                    </ul>
                    <Link to='/contact' className='text-center'>
                    <button className=" text-white font-medium rounded-lg text-sm px-5 py-2.5">Get Started</button></Link>
                  </div>
                  ...
                  {/* Premium Package */}
                  <div className="card bg-darkblue text-white p-8 rounded-lg  hover:shadow-glow">
                    <h3 className="text-xl text-white mb-4 font-bold">Premium</h3>
                    <p className="text-2xl text-white font-bold mb-4">$4500</p>
                    <ul className=" mb-8">
                      <li className="mb-2">Premium Website Design</li>
                      <li className="mb-2">Responsive Layout</li>
                      <li className="mb-2">15 pages</li>
                      <li className="mb-2">Premium SEO</li>
                      <li className="mb-2">Any Change</li>
                    </ul>
                    <Link to='/contact' className='text-center'>
                    <button className=" text-white font-medium rounded-lg text-sm px-5 py-2.5">Get Started</button></Link>
                  </div>
                  ...
                  <div className="card bg-darkblue text-white p-8 rounded-lg hover:shadow-glow">
                    <h3 className="text-xl text-center text-white mb-4 font-bold">Custom</h3>
                    <p className="text-2xl text-white text-center font-bold mb-4">$ </p>
                    <ul className=" mb-8">
                      <li className="mb-2">Custom  Website Design</li>
                      <li className="mb-2">Responsive Layout</li>
                      <li className="mb-2">Up to 20 pages</li>
                      <li className="mb-2">Any Choice of SEO</li>
                      <li className="mb-2">Any Choice of Changes</li>
                    </ul>
                    <Link to='/contact' className='text-center'>
                    <button className=" text-white font-medium rounded-lg text-sm px-5 py-2.5">Get Started</button></Link>
                  </div>
