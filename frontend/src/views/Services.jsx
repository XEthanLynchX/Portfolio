...
const Services = () => {
  return (
    <>
    {/* header */}
      <div className="flex md:flex-row items-top justify-around min-h-screen p-4 sm:p-10 font-cambria">
      ...
      <div className="flex justify-center items-center h">
        <div className="relative w-4/5">
          <div className="absolute inset-0 z-0 bg-darkblue backdrop-blur-lg rounded-lg"></div>
